...
import strategies.LowerRobotBehaviour;
...
public class Robot {
     ...
     */
    public Robot(IRobotBehaviour behaviour, IMailDelivery delivery, IMailPool mailPool, boolean strong, boolean big){
    	id = "R" + hashCode();
        // current_state = RobotState.WAITING;
    	current_state = RobotState.RETURNING;
        current_floor = Building.MAILROOM_LOCATION;
        if (!big) {max_capacity = 4;}
        else {max_capacity = 6;}
        tube = new StorageTube(max_capacity); 
        ...
        this.lower = behaviour instanceof LowerRobotBehaviour? true : false;
    }
    ...
    public void step() throws ExcessiveDeliveryException, ItemTooHeavyException{    	
    	switch(current_state) {
    		...
    		case WAITING:
    			...
    			mailPool.fillStorageTube(tube, this.lower);
    		...
    		case DELIVERING:
    			...
    			if(current_floor == destination_floor){ // If already here drop off either way
                    ...
                    deliveryCounter++;
                    if(deliveryCounter > max_capacity){
